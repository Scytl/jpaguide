...
public class MoviesServiceTest {
    ...
    // tag::onetomany[]
    @Test
    @ApplyScriptBefore("scripts/drop-referential-integrity.sql") //<1>
    ...
    public void shouldFindMoviesByTitleCriteria() {
        ...
        expectedMovie.setTitle("The Matrix");
        expectedMovie.setReleasedYear(1999);
        List<Movie> movies = moviesService.findMoviesByTitleCriteria("The Matrix");
        assertThat(movies, hasItem(expectedMovie));
    }
 ...
 // tag::metamodel[]
    ...
    public void shouldFindMoviesByTitleCriteriaMetamodel() {
        ...
        expectedMovie.setTitle("The Matrix");
        expectedMovie.setReleasedYear(1999);
        List<Movie> movies = moviesService.findMoviesByTitleCriteriaMetamodel("The Matrix");
        assertThat(movies, hasItem(expectedMovie));
    }
